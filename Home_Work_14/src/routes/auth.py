...
from src.schemas import UserModel, UserResponse, TokeModel, RequestEmail
...
@router.get('/refresh_token', response_model=TokeModel)
async def refresh_token(credentials: HTTPAuthorizationCredentials = Security(security), db: Session = Depends(get_db)):
    ...
    :param credentials: HTTPAuthorizationCredentials: Pass in the credentials from the request
